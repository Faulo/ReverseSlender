...
namespace SDFr
{
    public readonly struct AVolumeSettings
    {
        ...
        public AVolumeSettings(Bounds boundsLocal, Vector3Int dimensions, bool standardBorder)
        {
            ...
            Debug.Log($"AVolumeSettings BCenter {BoundsLocal.center} BSize: {BoundsLocal.size} Dim: {Dimensions}  Cells: {CellCount} MaxDim: {MaxDimension} VoxelSize: {VoxelSize:F3}");
        ...
        public static void AddBoundsBorder(ref AVolumeSettings settings)
        {
            ...
            Vector3 extraBorderVoxelSize = new(
            ...
            Bounds newBounds = new(settings.BoundsLocal.center, settings.BoundsLocal.size + (extraBorderVoxelSize * 2f));
